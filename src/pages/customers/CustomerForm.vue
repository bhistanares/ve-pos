...
import { Button, InputText, useToast, Message } from 'primevue'
...
const idEdit = computed(() => !!customerId.value)
...
const submit = async () => {
    ...
    try {
        ...
        toast.add({
            severity: "success",
            summary: "Success",
            detail: idEdit.value ? "Customer update succesfully" : "Customer created succesfully",
            life: 3000
        })
...
<template>
    <div class="min-h-screen bg-surface-50 font-sans text-surface-900">
        ...
        <div class="bg-white rounded-2xl border border-surface-200 p-2 w-full">
