...
import { Button, FileUpload, InputText, Textarea, useToast, Message } from 'primevue'
...
const idEdit = computed(() => !!categoryId.value)
...
const submit = async () => {
    ...
    try {
        ...
        toast.add({
            severity: "success",
            summary: "Success",
            detail: idEdit.value ? "Category update succesfully" : "Category created succesfully",
            life: 3000
        })
