...
import { Button, FileUpload, InputText, InputNumber, Select, useToast, Message } from 'primevue'
...
const idEdit = computed(() => !!productId.value)
...
const submit = async () => {
    ...
    try {
        ...
        toast.add({
            severity: "success",
            summary: "Success",
            detail: idEdit.value ? "Product update succesfully" : "Product created succesfully",
            life: 3000
        })
...
onMounted(async () => {
    ...
    try {
        ...
        form.value.product_category_id = data.product_category_id ?? data.category?.id ?? null
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
                    <div class="md:col-span-4 flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <small class="text-surface-500 text-xs text-center">Max size: 2MB. Formats: JPG, 
                                PNG.</small>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-8 flex flex-col gap-6">
                        <div class="flex flex-col gap-2">
                            ...
                            <Select id="product_category_id" v-model="form.product_category_id" 
                                ...
                                placeholder="Select a category" filter filterPlaceholder="Search Category..." fluid
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="flex flex-col gap-2">
                                ...
                                <InputNumber id="price" v-model="form.price" :min="0" mode="currency" 
                                    currency="IDR" locale="id-ID" fluid
                                    class="bg-surface-50! focus:bg-white! border-surface-200" 
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <InputNumber id="stock" v-model="form.stock" :min="0" fluid
                                    class="bg-surface-50! focus:bg-white! border-surface-200" 
