...
<template>
    <div class="flex items-center justify-center min-h-screen bg-surface-50 px4 py-10">
        <div class="w-full max-w-100">
            <div class="bg-white p-8 rounded-2xl shadow-xl border border-surface-100">
                <!-- header -->
                 <div class="text-center mb-8">
                    <div 
                        class="w-12 h-12 bg-primary-600 rounded-xl flex items-center justify-center text-white shadow-primary-200 mx-auto mb-4">
